...
import {
    ...
    findAllInvoices,
    updateInvoiceStatus as updateInvoiceStatusModel,
    updateInvoice,
} from '../models/Invoice';
...
class InvoiceController {
    ...
    async getAllInvoices(req: Request, res: Response) {
        ...
        if (req.query.userId) {
            filters.user_id = parseInt(req.query.userId as string);
        }
        if (req.query.paymentPlanId) {
            filters.payment_plan_id = parseInt(req.query.paymentPlanId as string);
        }
        ...
        const invoices: Invoice[] = result.rows;
     ...
     */
    async getInvoicesByPaymentPlan(req: Request, res: Response) {
